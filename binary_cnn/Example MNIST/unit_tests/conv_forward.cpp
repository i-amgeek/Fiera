...
int main()
{
    // tensor_t<float> temp_in(2, 3, 3, 2), filters(2, 2, 2, 2), expected_output(2, 2, 2, 2), out(2, 2, 2, 2);
    ...
    tensor_t<float> temp_in(16, 4, 20, 20), filters(8, 4, 3, 3), expected_output(2, 2, 2, 2), out(16, 8, 18, 18);
    conv_layer_t * layer = new conv_layer_t( 1, 3, 8, {16, 4, 20, 20}, false);
    layer->in = temp_in;
    layer->filters = filters;
    out = layer->activate(temp_in, 1);
